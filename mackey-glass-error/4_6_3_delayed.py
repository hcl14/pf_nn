...
np.random.seed(10) # this random seed corresponds to the correct convergence, otherwise the model is very likely to end in local minima
...
l1_window = 19 #total moving window
subset = [0,6,12,18]
