% This demo shows how the Metropolis-Hastings algorithm can be used to sample from a mixture of 2 Gaussians
% if we can sample from a Gaussian proposal. It uses 1000 parallel chains, which are initialised uniformly.
